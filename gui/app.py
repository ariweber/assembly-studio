"""Main GUI Application for Assembly Studio"""
...
from vm import Machine, AsmError, run_program, run_program_steps, get_python_equivalent, parse_program
from data import EXAMPLES
from .styles import COLORS, darken_color
